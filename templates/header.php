<html>
    <head>
        ...
        <link rel="stylesheet" href=<?php echo "\"". Engine::getInstance()->getDomName() . "css/fool.css" . "\""?> type="text/css">
    </head>
    <body>
    <div class="wrapper">
    <div class="slider slider_count_4">
        ...
        <div class="item">
            <img alt="" title="" src=<?php echo "\"". Engine::getInstance()->getDomName() . "img/Slider-1.jpg" . "\""?>>
        </div>
        <div class="item">
            <img alt="" title="" src=<?php echo "\"". Engine::getInstance()->getDomName() . "img/Slider-2.jpg" . "\""?>>
        </div>
        <div class="item">
            <img alt="" title="" src=<?php echo "\"". Engine::getInstance()->getDomName() . "img/Slider-3.jpg" . "\""?>>
        </div>
        <div class="item">
            <img alt="" title="" src=<?php echo "\"". Engine::getInstance()->getDomName() . "img/Slider-4.jpg" . "\""?>>
        </div>
